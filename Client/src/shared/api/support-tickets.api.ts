...
export const supportTicketsApi = {
  ...
  create: (payload: FormData) => request.post<SupportTicketDetail>('/api/support/tickets', payload),
  getMineById: (id: string) => request.get<SupportTicketDetail>(`/api/support/tickets/${id}`),
  addUserMessage: (id: string, payload: FormData) =>
    request.post<SupportTicketDetail>(`/api/support/tickets/${id}/messages`, payload),
  ...
  addAdminMessage: (id: string, payload: FormData) =>
    request.post<SupportTicketDetail>(`/api/admin/support-tickets/${id}/messages`, payload),
