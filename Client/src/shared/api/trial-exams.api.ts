import type { CreateTrialExam, PublicTrialExamSummary, TrialExamDetail, TrialExamSummary, UpdateTrialExam } from '../../models'
import { request } from './client'

export const trialExamsApi = {
  getAll: () => request.get<TrialExamSummary[]>('/api/trial-exams'),
  getFree: () => request.get<PublicTrialExamSummary[]>('/api/trial-exams/free'),
